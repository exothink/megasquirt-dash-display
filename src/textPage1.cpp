...
void textPage1(void)
{
	...
	//rpm = scalar, U16, 6, "RPM", 1.000, 0.0
	 ...
	 Serial.println(RPM);
	// Serial.println(msCAN_Data[7].U08[0]);
	...
	textDataf(10, tpos+=FONTHEIGHT, CLT, "CLT:", "%0.0f F", 0, -10, 205, 220);
	...
	float BATTV = msCAN_S16(msCAN_Data[adrBattery].U08[0]) * 1.0f;
	textDataf(10, tpos+=FONTHEIGHT, BATTV, "BATT:", "%0.0f V", 10, 9, 15, 16);
